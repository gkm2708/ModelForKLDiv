...
class DDPG(object):
    def __init__(self, actor, critic, memory, observation_shape, action_shape, param_noise=None, action_noise=None,
        ...
        self.t_encoder_tf_mu, self.t_encoder_tf_sigma = target_actor(self.normalized_obs0, True)
        ...
        self.t0_kl = tf.reshape(tf.reduce_sum(tf.exp(self.t_encoder_tf_sigma) + tf.square(self.t_encoder_tf_mu) - 1. - self.t_encoder_tf_sigma, axis=1),(-1,1))
        ...
        self.target_Q = self.rewards + 0.0 * self.kls + (1. - self.terminals1) * gamma * Q_obs1
